    ...
    <div className="container login">
      <div className="row align-items-center justify-content-center py-5">
        <div className="col-md-8">
          <h1 className="text-blue-gradient fw-bold">LOGO</h1>
          <p className="text-blue-gradient mt-4 w-75">
        ...
        <div className="col-md-4 login-box border-grey-5 rounded-8 px-4 py-5 justify-content-center text-center">
