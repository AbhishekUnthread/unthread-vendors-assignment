...
function createData(vId, variantSets, variants) {
  return { vId, variantSets, variants };
}

const rows = [
  createData(1, "Ring Sets", "Size, Metal, Diamond"),
  createData(2, "Bangle Sets", "Size, Metal, Diamond"),
  createData(3, "Chain Sets", "Size, Metal, Diamond"),
];
...
export default VariantSetsTable;
