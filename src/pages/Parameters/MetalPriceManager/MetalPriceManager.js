    ...
    <div className="container-fluid page">
      <div className="row justify-content-between align-items-center">
        <div className="d-flex align-items-center w-auto ps-0">
          ...
          <h5 className="page-heading ps-1 ms-2">Metal Price Manager</h5>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Tab label="Gold" className="tabs-head" />
              <Tab label="Silver" className="tabs-head" />
              <Tab label="Platinum" className="tabs-head" />
            </Tabs>
          </Box>
