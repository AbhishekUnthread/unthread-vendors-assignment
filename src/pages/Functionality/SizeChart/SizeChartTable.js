...
const rows = [
  createData(1, "Ring Size Chart", "1,423", "20/02/23 at 09:23am", "Active"),
  createData(
    2,
    "Necklace Size Chart",
    "1,423",
  ...
  createData(3, "Bangles Size Chart", "1,423", "20/02/23 at 09:23am", "Active"),
  createData(4, "Ring Size Chart", "1,423", "20/02/23 at 09:23am", "Active"),
];
        ...
        <div className="d-flex align-items-center px-2 mb-3">
          <button className="button-grey py-2 px-3">
            <small className="text-lightBlue">
              {selected.length} size chart are selected&nbsp;
              <span
