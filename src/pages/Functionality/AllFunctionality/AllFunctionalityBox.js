...
const AllFunctionalityBox = ({ headingName, imageName, buttonName }) => {
  return (
    <div className="bg-black-15 hover-back-two rounded-8 d-flex flex-column p-3 justify-content-start align-items-baseline">
      <div className="text-end w-100">
        <img src={imageName} alt="functionalitySize" className="" width={75} />
      </div>
      <h5 className="text-blue-gradient fw-500">{headingName}</h5>
