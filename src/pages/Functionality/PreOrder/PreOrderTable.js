...
// ? TABLE STARTS HERE
function createData(sId, name, noOfProducts, createdAt, status) {
  return { sId, name, noOfProducts, createdAt, status };
}

const rows = [
  createData(1, "New Arrival", "1,423", "20/02/23 at 09:23am", "Active"),
  createData(2, "Best Sellers", "1,423", "20/02/23 at 09:23am", "Active"),
  createData(3, "Coming Soon", "1,423", "20/02/23 at 09:23am", "Active"),
  createData(4, "50% Sale", "1,423", "20/02/23 at 09:23am", "Active"),
];
                  ...
                  >
                    ...
                    <TableCell style={{ width: 260 }}>
                      <div className="d-flex align-items-center">
                        <p className="text-lightBlue me-2">{row.createdAt}</p>
