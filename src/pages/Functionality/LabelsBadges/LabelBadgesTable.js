...
function createData(
  ...
  return { sId, name, labelBadge, noOfProducts, type, createdAt, status };
}
                  ...
                  >
                    ...
                    <TableCell style={{ width: 180 }}>
                      <div className="d-flex align-items-center">
                        <div className=" p-2 rounded-4 bg-red-4 table-status w-auto">
                          <p className="text-black fw-400">{row.labelBadge}</p>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell style={{ width: 180 }}>
...
export default LabelBadgesTable;
