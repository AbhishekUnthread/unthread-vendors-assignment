...
const rows = [
  createData(1, "Archived JWL Karol Bagh", "25", "Active"),
  createData(2, "Archived JWL Karol Bagh", "25", "Active"),
  createData(3, "Archived JWL Karol Bagh", "25", "Active"),
  createData(4, "Archived JWL Karol Bagh", "25", "Active"),
  createData(5, "Archived JWL Karol Bagh", "25", "Active"),
  createData(6, "Archived JWL Karol Bagh", "25", "Active"),
  createData(7, "Archived JWL Karol Bagh", "25", "Active"),
];
