        ...
        <div className="col-lg-3 pe-0 ps-0 ps-lg-3">
          <div className="bg-black-15 border-grey-5 rounded-8 p-3 mt-4">
            ...
            <div className="d-flex justify-content-between mt-2">
              <small className="text-grey-6 w-75">Subtotal</small>
              <small className="text-blue-1 w-25 text-end">₹ 20,600 </small>
            </div>
            <div className="d-flex justify-content-between mt-2">
              <small className="text-grey-6 w-75">
            ...
            <div className="d-flex justify-content-between mt-2">
              ...
              <small className="text-blue-1 w-25 text-end">₹ 350</small>
            </div>
            <div className="d-flex justify-content-between mt-2">
              <small className="text-grey-6 w-75">
                Shipping&nbsp;
              ...
              <small className="text-blue-1 w-25 text-end">Free</small>
            </div>
            <div className="d-flex justify-content-between mt-2">
              <small className="text-grey-6 w-75">
                Labour Charges&nbsp;
              ...
              <small className="text-blue-1 w-25 text-end">₹ 2300</small>
            </div>
